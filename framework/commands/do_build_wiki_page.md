...
### Step 4: Visual Elements — Mermaid Diagrams

When a concept benefits from visual representation, use fenced Mermaid code blocks:
...
- **Pie charts** — allocation breakdowns, composition summaries
