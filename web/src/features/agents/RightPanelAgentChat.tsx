                ...
                {proposalDiffGroups(activeProposal).map((group) => (
                  <div className="agent-edit-proposal-file" key={group.filePath}>
                    ...
                    {group.conceptualDiffs.map((diff) => {
                      ...
                      return (
                        <div className={proposalReadOnly ? "agent-edit-proposal-diff read-only" : "agent-edit-proposal-diff"} key={diff.id}>
                            ...
                            <div className="agent-edit-proposal-diff-title">
                              ...
                              {scopeLabel || impactLabel || memoryLabel ? (
                                <span className="agent-edit-proposal-badges">
                                  {scopeLabel ? (
                                    <span className={elevated ? "agent-edit-proposal-badge elevated" : "agent-edit-proposal-badge"}>{scopeLabel}</span>
                                  ) : null}
                                  {memoryLabel ? <span className="agent-edit-proposal-badge memory">{memoryLabel}</span> : null}
                                  {impactLabel ? (
                                    <span className={diff.applyNotes?.riskLevel === "high" ? "agent-edit-proposal-badge elevated" : "agent-edit-proposal-badge"}>
                                      {impactLabel}
                                    </span>
                                  ) : null}
                                </span>
