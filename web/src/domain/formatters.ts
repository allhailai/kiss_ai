...
export function formatLocalDate(timestamp: string | null | undefined, emptyLabel = "None") {
  if (!timestamp) return emptyLabel;
...
export function formatLocalTimeShort(timestamp: string | null | undefined, emptyLabel = "None") {
  if (!timestamp) return emptyLabel;
